  ...
  Future<void> _loadThemes() async {
    try {
      ...
      if (allThemes is List) {
        for (final entry in allThemes.whereType<Map<String, dynamic>>()) {
          final theme = entry['theme'];
          if (theme is! Map<String, dynamic>) continue;
      ...
      setState(() {
        ...
        if (filtered.isNotEmpty) {
          final firstTheme = filtered.first['theme'] as Map<String, dynamic>? ??
              ...
              SizedBox(
                ...
                child: ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    final theme = _themes[index]['theme'] as Map<String, dynamic>? ??
                        const <String, dynamic>{};
