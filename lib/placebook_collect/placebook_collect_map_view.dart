...
import '../map/widgets/map_navigation_view.dart';
import '../map/map_filter/map_filter_view.dart';
...
class _PlacebookCollectMapViewState extends State<PlacebookCollectMapView>
  ...
  Future<void> _fetchPlacebookSpaces() async {
    ...
    try {
      ...
      final shouldUseClusters = !_shouldFitAllPlaces && _shouldUseClusterApi(zoom);
